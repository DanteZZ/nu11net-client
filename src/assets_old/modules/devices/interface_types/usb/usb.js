class usb {
	...
	__onConnect = function () {
		...
		let catf = "interfaces/" + this.__type + "/" + this._id + "/";
		this.__device._cmd._sendEvent(catf + "onconnect", this.port_connection._interfaceList())
	};

	__onUnconnect = function () {
		let catf = "interfaces/" + this.__type + "/" + this._id + "/";
		this.__device._cmd._sendEvent(catf + "ondisconnect", this.port_connection._interfaceList())
